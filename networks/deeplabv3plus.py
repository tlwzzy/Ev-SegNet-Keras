...
def aspp(x, input_shape, out_stride):
    ...
    out_shape_1 = int(input_shape[0] / out_stride)
    out_shape_2 = int(input_shape[1] / out_stride)
    b4 = AveragePooling2D(pool_size=(out_shape_1, out_shape_2))(x)
    b4 = Conv2D(256, (1, 1), padding="same", use_bias=False)(b4)
    b4 = BatchNormalization()(b4)
    b4 = Activation("relu")(b4)
    b4 = BilinearUpsampling((out_shape_1, out_shape_2))(b4)

    x = Concatenate()([b4, b0, b1, b2, b3])
    return x


# out_stride=16 default
def deeplabv3_plus(input_size=(512, 512, 3), out_stride=16, num_class=21, lr=0.01, momentum=0.9):
